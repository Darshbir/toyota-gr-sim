...
class InsightsGenerator:
    ...
    def _build_prompt(self, race_data: Dict) -> str:
        ...
        prompt = f"""You are an expert  race strategist and simulation analyst with deep knowledge of Formula 1 racing strategy, tire management, pit stop optimization, and race simulation data analysis.
